      ...
      body: Column(
        ...
        children: [
          ScaleTransition(scale: animation,
            child: Center(child: Image.asset("assets/images/logo part 1.png", width: AppLayout.getWidth(250),))),
          Center(child: Image.asset("assets/images/logo part 2.png", width: AppLayout.getWidth(250),))
        ],
      ),
    );
  }
